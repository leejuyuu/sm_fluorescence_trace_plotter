...
for iFile in range(0, nFiles):
    ...
    for iAOI in range(0, nAOIs):
        ...
        plt.subplot(2, 1, 1)
        plt.plot(frames, red[iAOI,], color='red')
        plt.plot(frames, redVit[iAOI, :, 0], color='black', linewidth=2)
        plt.xlim((0, nFrames))
        plt.ylabel('Intensity', fontsize=16)
        ...
        #plt.plot(frames, green[iAOI,], color='green')
        plt.plot(frames, greenVit[iAOI, :, 0], color='black', linewidth=2)
