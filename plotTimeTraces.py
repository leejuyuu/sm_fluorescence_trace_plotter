...
import pandas as pd
dfs = pd.read_excel("D:/TYL/Google Drive/Research/All software editing/Imscroll-and-Utilities/imscroll/data/testautomate.xlsx", "Sheet1")
nFiles = dfs.shape[0]
for iFile in range(0,nFiles)
    filestr = dfs[iFile,'filename']
