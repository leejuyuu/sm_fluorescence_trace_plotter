...
/Imscroll-and-Utilities/imscroll/data/testautomate.xlsx')
...
for iFile in range(0, nFiles):
    ...
    for i in range(0, nAOI):
        ...
        frames = intervals[0, 0]['AllTracesCellArray'][i, 0][:, 1]
        ...
        plt.savefig(datapath / filestr / ('molecule{}.png'.format(i+1)), Transparent=True,
